...
<div class="content">
    ...
    <form action="{{ route('agents.update', $agent->agentID) }}" method="POST">
        ...
        <div class="medDIV">
            ...
            <input class="input-form" type="number" step="0.01" name="comrate" id="comrate" value="{{ $agent->comrate }}" required>
            <br>

            <label for="area">Area:</label>
            <input class="input-form" type="text" name="area" id="area" value="{{ $agent->area }}" required>
            <br>
